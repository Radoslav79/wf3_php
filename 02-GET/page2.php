...
//--------------------------------
//$_GET représente l'information qui transite dans l'URL. Il s'agit d'une superglobale, et donc, comme toutes les superglobales, d'un array. Par ailleurs, superglobale signifie que cette variable est disponible dans tous les contextes du script, y compris dans l'especa local des fonctions sans avoir besoin de faire "globale $_GET".

// Les informations transitent dans l'URL selon le syntaxe suivante :
...
// Vérifier que l'on reçoit de l'information
echo '<pre>';
print_r($_GET);
echo '</pre>';
