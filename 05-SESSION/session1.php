...
// Tous les sites qui fontionnent sur le principe de connexion (site bancaire...) ou qui ont besoin de suivre un internaute de page en page (avec son panier par exemple) utilisent les sessions.
...
// Supprission detoute la session : 
// session_destroy(); // Suppression de la session MAIS il faut savoir que le session_destroy() est d'abord vu par l'interpréteur qui ne l'éxecute qu'à la fin du script. 
...
// Conclusion : Les sessions ont l'avantage d'être disponibles partout sur le site : voir session2.php. 
